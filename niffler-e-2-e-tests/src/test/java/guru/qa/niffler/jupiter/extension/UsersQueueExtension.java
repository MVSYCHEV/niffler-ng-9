...
public class UsersQueueExtension implements
	...
	static {
		EMPTY_USERS.add(new StaticUser("sychev", "123123", true));
		NOT_EMPTY_USERS.add(new StaticUser("sychevTest", "12341234", false));
		NOT_EMPTY_USERS.add(new StaticUser("registerTestUser", "pass", false));
	}
